        ...
        <div className='container'>
            <div className='HeaderFlex dFlex justifyContentBetween alignItemCenter'>
                ...
                <div className='headerinfo'>
                    <ul>
                        <li> <svg fill="#000000" height="20px" width="20px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" 
...
</svg> +91 996 842 4239</li>
                        <li><svg width="20px" height="25px" viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
